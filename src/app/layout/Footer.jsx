...
const Footer = () => {
  const { premium, loading } = useAuth(); // ✅ get premium state

  return (
    <div className={styles.footer}>
      <Grid columns={premium || loading ? 3 : 4} divided stackable>
        <Grid.Row>
          <Grid.Column>
            <List>
          ...
          {!loading && !premium && (
            <Grid.Column>
              ...
              <Button
                as={Link}
                to="/pay"
                className={`btn-primary ${styles.plansBtn}`}
              >
                Upgrade
              </Button>
            </Grid.Column>
