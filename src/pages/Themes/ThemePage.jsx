  ...
  return (
    <div className={styles.page}>
      ...
      <p className={styles.subtext}>
        Pick a single brand color to generate a palette, or fine-tune below.
      ...
      <div className={styles.section}>
        <div className={styles.fineControls}>
            ...
            <label key={key} className={styles.label}>
              ...
              <input
                ...
                onChange={(e) =>
                  setDraft((prev) => ({
                    ...prev,
                    [key]: asHex(e.target.value, DEFAULT_THEME[key]),
                  }))
                }
              />
            </label>
          ...
          <button
            className={`btn-primary ${styles.applyButton}`}
            onClick={() => updateTheme(draft)}
          >
            Apply Changes
          </button>
        </div>
                ...
                <div className={styles.swatches}>
                  {[
                    ...
                    <div
                      ...
                      style={{ background: p.theme?.[k] || "transparent" }}
                    />
                  ))}
                </div>
